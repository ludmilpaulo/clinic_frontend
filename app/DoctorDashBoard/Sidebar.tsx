...
import { FaUser, FaCalendarAlt, FaClipboardList, FaStethoscope, FaPrescriptionBottleAlt, FaBars } from 'react-icons/fa';

type SidebarProps = {
  setSection: React.Dispatch<React.SetStateAction<'profile' | 'availability' | 'appointments' | 'consultations' | 'prescriptions'>>;
};
...
const Sidebar: React.FC<SidebarProps> = ({ setSection }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed lg:static h-screen w-64 bg-gray-800 text-white transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-10`}>
