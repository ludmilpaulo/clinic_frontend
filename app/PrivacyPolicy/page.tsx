  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <p className="text-sm text-gray-500 mb-4">Last updated: June 17, 2024</p>
        ...
        <p className="mb-4 text-gray-700">
          ...
          help of the{' '}
          <Link href="https://www.termsfeed.com/privacy-policy-generator/" passHref>
            <span className="text-blue-600 underline cursor-pointer">Privacy Policy Generator</span>
          </Link>
          .
        </p>
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">Interpretation and Definitions</h2>
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          ...
          <li className="mb-2">
            <p>
              <strong>Application</strong> refers to Men&apos;s Clinic - Expert Men&apos;s Health Solutions, the software program
          ...
          <li className="mb-2">
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Men&apos;s Clinic - Expert Men&apos;s Health Solutions.
            </p>
          </li>
          <li className="mb-2">
            <p>
          ...
          <li className="mb-2">
            <p>
              <strong>Website</strong> refers to Men&apos;s Clinic - Expert Men&apos;s Health Solutions, accessible from{' '}
              <Link href="https://www.trustmenclinic.com/BannerPage" passHref>
                <span className="text-blue-600 underline cursor-pointer">
                  https://www.trustmenclinic.com/BannerPage
                </span>
              </Link>
            </p>
          </li>
        ...
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">Collecting and Using Your Personal Data</h2>
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Types of Data Collected</h3>
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Personal Data</h4>
        <p className="mb-4 text-gray-700">
        ...
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Usage Data</h4>
        ...
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Tracking Technologies and Cookies</h4>
        <p className="mb-4 text-gray-700">
        ...
        <p className="mb-4 text-gray-700">
          ...
          <Link href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" passHref>
            <span className="text-blue-600 underline cursor-pointer">TermsFeed website</span>
          </Link>{' '}
          article.
        </p>
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Use of Your Personal Data</h3>
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Retention of Your Personal Data</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Transfer of Your Personal Data</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Delete Your Personal Data</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Disclosure of Your Personal Data</h3>
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Business Transactions</h4>
        <p className="mb-4 text-gray-700">
        ...
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Law enforcement</h4>
        <p className="mb-4 text-gray-700">
        ...
        <h4 className="text-xl font-semibold text-gray-700 mb-2">Other legal requirements</h4>
        <p className="mb-4 text-gray-700">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-2">Security of Your Personal Data</h3>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-3xl font-semibold text-gray-900 mb-4">Links to Other Websites</h2>
        <p className="mb-4 text-gray-700">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
          <li>
            ...
            <Link href="https://www.trustmenclinic.com" passHref>
              <span className="text-blue-600 underline cursor-pointer">
                https://www.trustmenclinic.com
              </span>
            </Link>
          </li>
        </ul>
